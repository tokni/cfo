const Language = {
  ...
  fo: {
    ...
    fillformtoaddtransaction: 'Fyll teigarnar fyri at leggja transaktion avtrat',
  ...
  de: {
    ...
    fillformtoaddtransaction: 'Füllen Sie dieses Formular aus, um ein Transaktionen hinzuzufügen',
