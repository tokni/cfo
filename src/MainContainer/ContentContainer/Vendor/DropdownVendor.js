...
import Modal from '../../../Helpers/DropdownModal'
...
const DropdownCreateVendor = props => {
...
DropdownCreateVendor.propTypes = {
  classes: PropTypes.object.isRequired,
}

export default withStyles(styles)(DropdownCreateVendor)
